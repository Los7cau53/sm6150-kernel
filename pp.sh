...
DEFCONFIG=vendor/lineage_phoenix_defconfig

# Specify compiler.
# 'clang' or 'gcc'
COMPILER=clang

# Clean source prior building 0 = cleans. 1= continue
INCREMENTAL=1
...
ZIPNAME="los7cau53kernel-$VERSION"
...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	...
	then
		...
		TC_DIR=$KERNEL_DIR/proton-clang
	elif [ $COMPILER = "gcc" ]
	then
...
exports() {
	export KBUILD_BUILD_USER="los7cau53"
        export KBUILD_BUILD_HOST="zfx-pc"
	export ARCH=arm64
...
release() {
        msg "|| Releasing Build ||"
	scp AnyKernel3/$ZIP_FINAL los7cau53@frs.sourceforge.net:/home/frs/p/los7cau53/phoenix/
...
90_hz_patch() {
	...
	ZIPNAME="los7cau53kernel-$VERSION-90Hz"
	rm -rf AnyKernel3/*.zip AnyKernel3/*.jar AnyKernel3/*.img AnyKernel3/*.gz-dtb
}
clone
exports
build_kernel
